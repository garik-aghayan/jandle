 ...
 * </p>
 * <pre>{@code
 * ResponseCookie cookie = new ResponseCookie("session", "abc123");
...
public class ResponseCookie {
	 ...
	 *
	 * @return this {@code ResponseCookie} for chaining.
	 */
	 ...
	 * @return this {@code ResponseCookie} for chaining.
	 */
	public ResponseCookie setSameSite(SameSite sameSite) {
	 ...
	 * @return this {@code ResponseCookie} for chaining.
	 */
	public ResponseCookie setHttpOnly(boolean httpOnly) {
	 ...
	 * @return this {@code ResponseCookie} for chaining.
	 */
	public ResponseCookie setPartitioned(boolean partitioned) {
	 ...
	 * @return this {@code ResponseCookie} for chaining.
	 */
	public ResponseCookie setMaxAgeSeconds(long maxAgeSeconds) {
	 ...
	 * @return this {@code ResponseCookie} for chaining.
	 */
	public ResponseCookie setExpiresMillis(long expiresMillis) {
